        ...
        <div className="">
            ...
            <div className="container mx-auto py-12 px-6 md:px-12 flex justify-between md:flex-row flex-col items-center md:items-start gap-16">
                ...
                <div className="md:w-1/2 mb-8">
                    <h2 className="text-3xl font-medium font-poppins text-seconderyGreen mb-4">Get in Touch</h2>
                ...
                <div className="md:w-1/2 w-full">
                    <h2 className="text-3xl font-medium font-poppins text-seconderyGreen  mb-7">Send Us a Message</h2>
                    <form className="mb-8">
                        <div className="mb-4">
